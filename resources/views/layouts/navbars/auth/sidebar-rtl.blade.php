    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link " href="{{ url('dashboard') }}">
          ...
          {{-- tulisan arab jadi sidebarBARU --}}
          <span class="nav-link-text me-1">sidebarBARU</span>
        </a>
      </li>
      <li class="nav-item">
  ...
  <div class="sidenav-footer mx-3 ">
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      ...
      <div class="card-body text-start p-3 w-100">
        ...
        <div class="docs-info">
          <h6 class="text-white up mb-0 text-end">Please check our docs sidebarBARU</h6>
          <p class="text-xs font-weight-bold text-end">Please check our docs sidebarBARU</p>
          <a href="/documentation/getting-started/overview.html" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Documentation sidebarBARU</a>
        </div>
      </div>
    </div>
