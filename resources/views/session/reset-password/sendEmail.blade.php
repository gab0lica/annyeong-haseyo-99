...
<div class="page-header min-vh-100"><!--section-height-75 = min-vh-100-->
    <div class="container">
        <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                <div class="card card-plain mt-4"><!--mt-8 = mt-4-->
                    <div class="card-header pb-0 text-left bg-transparent">
                        <h2 class="font-weight-bolder text-info text-gradient mt-0">Korean Looks</h2>
                    </div>
                    {{-- @if($errors->any())
                    ...
                    <div class="card-body">
                        ...
                        <form action="/forgot-password" method="POST" role="form text-left">
                            @csrf
                            <div>
                                <p class="text-secondary" for="email">Email</p><!--awalnya label-->
                                <div class="">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn bg-gradient-dark w-100 mt-4 mb-0">Recover your password</button>
                            </div>
                        </form>
                    </div>
                </div>
